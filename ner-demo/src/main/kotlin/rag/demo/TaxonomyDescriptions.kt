...
/**
 * Descriptions localisées de la taxonomie NER (38 labels fins + 9 familles coarse).
...
object TaxonomyDescriptions {
    ...
    private val FINE_FR = mapOf(
        ...
        "hint_org_name"       to "Organisation formelle nommée : entreprise, parti.\nEx : LVMH, PS, Apple, Greenpeace.",
        "hint_inst_name"      to "Institution publique NOMMÉE (sigle ou nom propre qualifié).\nEx : ONU, OTAN, Commission européenne, Sénat américain.",
        "hint_inst_role"      to "Institution GÉNÉRIQUE sans qualificatif.\nEx : gouvernement, police, armée, parlement, tribunal.",
        ...
        "hint_measure"        to "Mesure ou quantité physique avec unité.\nEx : 3 km, 500 kg, 20 MW, 10°C, 45 000 ha.",
        ...
        "hint_document"       to "Rapport, lettre, communiqué, contrat, données.\nEx : rapport annuel, communiqué de presse, contrat de bail.",
        "hint_work_generic"   to "Production culturelle générique sans titre.\nEx : film, livre, presse, médias, cinéma.",
        ...
        "hint_doctrine"       to "Doctrine, idéologie, courant de pensée.\nEx : libéralisme, marxisme, laïcité, keynésianisme.",
        "hint_state"          to "État, condition, situation abstraite.\nEx : pauvreté, crise, paix, guerre, récession.",
        "hint_notion"         to "Concept abstrait pur, valeur, principe, règle générique.\nEx : démocratie, liberté, souveraineté, droit international.",
        "hint_field"          to "Domaine ou secteur d'activité.\nEx : santé, éducation, agriculture, finance, défense.",
    )
    ...
    private val FINE_EN = mapOf(
        ...
        "hint_org_name"       to "Named formal organisation: company, party.\nE.g. LVMH, Labour, Apple, Greenpeace.",
        "hint_inst_name"      to "NAMED public institution (acronym or qualified proper name).\nE.g. UN, NATO, European Commission, US Senate.",
        "hint_inst_role"      to "GENERIC institution without qualifier.\nE.g. government, police, army, parliament, court.",
        ...
        "hint_measure"        to "Physical quantity or measure with unit.\nE.g. 3 km, 500 kg, 20 MW, 10°C, 45,000 ha.",
        ...
        "hint_document"       to "Report, letter, press release, contract, data.\nE.g. annual report, press release, lease agreement.",
        "hint_work_generic"   to "Generic cultural production without title.\nE.g. film, book, press, media, cinema.",
        ...
        "hint_doctrine"       to "Doctrine, ideology, school of thought.\nE.g. liberalism, Marxism, secularism, Keynesianism.",
        "hint_state"          to "State, condition, abstract situation.\nE.g. poverty, crisis, peace, war, recession.",
        "hint_notion"         to "Pure abstract concept, value, principle, generic rule.\nE.g. democracy, freedom, sovereignty, international law.",
        "hint_field"          to "Domain or sector of activity.\nE.g. health, education, agriculture, finance, defence.",
    )
    ...
    private val COARSE_FR = mapOf(
        ...
        "ORG"      to "🏢 Organisations\nentreprises, institutions nommées, institutions génériques",
        ...
        "VALUE"    to "🔢 Valeurs numériques\nmesures, pourcentages, comptes, montants, taux",
        "WORK"     to "📚 Productions intellectuelles\nœuvres d'art, lois, documents, productions culturelles génériques",
        "ABSTRACT" to "💡 Concepts & états abstraits\nmaladies, langues, doctrines, états, notions, domaines",
    )
    ...
    private val COARSE_EN = mapOf(
        ...
        "ORG"      to "🏢 Organizations\ncompanies, named institutions, generic institutions",
        ...
        "VALUE"    to "🔢 Numeric values\nmeasures, percentages, counts, amounts, rates",
        "WORK"     to "📚 Intellectual productions\nartworks, laws, documents, generic cultural productions",
        "ABSTRACT" to "💡 Concepts & abstract states\ndiseases, languages, doctrines, states, notions, fields",
    )
    ...
    private val COARSE_DE = mapOf(
        ...
        "WORK"     to "📚 Intellektuelle Produkte\nKunstwerke, Gesetze, Dokumente, generische Kulturprodukte",
        "ABSTRACT" to "💡 Konzepte & abstrakte Zustände\nKrankheiten, Sprachen, Doktrinen, Zustände, Begriffe, Bereiche",
    )
    ...
    private val COARSE_ES = mapOf(
        ...
        "EVENT"    to "⚡ Eventos\nnombrados (COP28, JJ.OO…) o nominales (la guerra, la crise…)",
        "OBJECT"   to "📦 Objetos físicos\narmas, vehículos, sustancias, alimentos, herramientas",
        "VALUE"    to "🔢 Valores numéricos\ncantidades, medidas, porcentajes, conteggi, importes, tasas",
        "WORK"     to "📚 Producciones intelectuales\nobras de arte, leyes, documentos, producciones culturales genéricas",
        "ABSTRACT" to "💡 Conceptos y estados abstractos\nenfermedades, idiomas, doctrinas, estados, nociones, campos",
    )

    private val COARSE_IT = mapOf(
        "PER"      to "👤 Persone e gruppi umani\nnomi propri, ruoli/titoli, nazionalità, collettivi",
        "LOC"      to "📍 Luoghi\nentità geopolitiche, monumenti, luoghi genérici, infrastrutture",
        ...
        "WORK"     to "📚 Produzioni intellettuali\nopere d'arte, leggi, documenti, produzioni culturali geniche",
        "ABSTRACT" to "💡 Concetti e stati astratti\nmalattie, lingue, dottrine, stati, nozioni, ambiti",
    )
    ...
    val COARSE_TO_FINE = mapOf(
        ...
        "ORG"      to listOf("hint_org_name","hint_inst_name","hint_inst_role"),
        ...
        "VALUE"    to listOf("hint_measure","hint_percentage","hint_count","hint_money","hint_rate"),
        "WORK"     to listOf("hint_work_of_art","hint_law","hint_document","hint_work_generic"),
        "ABSTRACT" to listOf("hint_disease","hint_language","hint_doctrine","hint_state","hint_notion","hint_field"),
    )
