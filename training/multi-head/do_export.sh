...
CHECKPOINT="${NER_CHECKPOINT:-$REPO_ROOT/models/deberta/fine-tuning-22042026/checkpoint_best_multitask.pt}"
OUT_DIR="${NER_OUT_DIR:-$REPO_ROOT/models/deberta/fine-tuning-22042026}"
...
echo "   Int8 q8 : $OUT_Q8   ← utiliser ce modèle en Java"
echo "   Log     : $LOG"
echo ""
