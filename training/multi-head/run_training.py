...
def run_epoch(cfg: dict, hw: dict, state: dict, lambdas: dict,
    ...
    cmd = [
        ...
        "--lambda-verb-family",        str(lambdas.get("verb_family", 0.0)),
        "--lambda-verb-family-fine",   str(lambdas.get("verb_family_fine", 0.0)),
        "--lambda-verb-polarity",      str(lambdas.get("verb_polarity", 0.0)),
        "--lambda-verb-aspect",        str(lambdas.get("verb_aspect", 0.0)),
        "--lambda-verb-source",        str(lambdas.get("verb_source", 0.0)),
        "--lambda-attributes",         str(lambdas.get("attributes", 0.0)),
