...
def main():
    ...
    parser.add_argument("--tau-boundary-grid", type=str, default="0.45,0.50,0.55,0.60,0.65,0.70")
    parser.add_argument("--tau-none-grid", type=str, default="0.40,0.45,0.50,0.55,0.60")
    parser.add_argument("--tau-coarse-grid", type=str, default="0.25,0.30,0.35,0.40,0.45")
