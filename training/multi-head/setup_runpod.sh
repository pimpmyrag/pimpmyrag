...
for lbl in ('hint_notion','hint_field','hint_state','hint_rule','hint_doctrine',
            'hint_process','hint_work_generic'):
    assert lbl in L.FINE2ID, f"{lbl} manquant dans labels.py"
